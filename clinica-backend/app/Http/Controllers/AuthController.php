 ...
 *     @OA\Property(property="nombre", type="string", example="Rocio"),
 *     @OA\Property(property="apellidos", type="string", example="Gordo"),
 *     @OA\Property(property="email", type="string", format="email", example="roogordo@hotmail.com"),
