 ...
 *   @OA\Property(property="descripcion", type="string", nullable=true, example="Resultados analítica mayo 2026"),
 *   @OA\Property(property="archivo", type="string", example="documentos/analitica_2026_05.pdf"),
 ...
 *   @OA\Property(property="created_at", type="string", format="date-time", example="2026-05-01T10:30:00Z"),
 *   @OA\Property(property="updated_at", type="string", format="date-time", example="2026-05-01T10:45:00Z")
 * )
 */
...
class DocumentoController extends Controller
{
     ...
     *           type="string",
     *           nullable=true,
     *           example="Analítica de sangre del 2026-04-10"
     *         ),
     *         @OA\Property(
     *           property="archivo",
     *           type="string",
