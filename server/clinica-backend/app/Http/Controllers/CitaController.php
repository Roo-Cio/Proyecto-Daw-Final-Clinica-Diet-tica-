...
class CitaController extends Controller
{
     ...
     *                     @OA\Property(property="fecha", type="string", format="date", example="2026-12-01"),
     ...
     *                 @OA\Property(property="fecha", type="string", example="01-12-2026"),
     *                 @OA\Property(property="hora", type="string", example="10:30"),
     ...
     *         required=true,
     *         @OA\Schema(type="string", format="date", example="2026-12-01")
     *     ),
     *     @OA\Response(
     *         response=200,
